...
@section('content')
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            <div class="mb-1 label">Tanggal BAST</div>
                            <input type="date" class="form-control" name="nama_bank" value="{{ old('') }}"
                                placeholder="Masukkan Nama Bank">
                            {{-- @error('nama_bank')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror --}}

                            <div class="mb-1 mt-2 label">Nomer Invoice</div>
                        ...
                        {{-- @error('nomer_rek')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror --}}
                        <div class="mb-1 mt-2 label">Deskripsi Singkat</div>
                        <input type="text" class="form-control" name="nomer_rek" value="{{ old('') }}"
                            placeholder="Masukkan Nomer Rekening">
                        {{-- @error('nomer_rek')
                            <div class="text-danger">{{ $message }}</div>
    ...
    <!-- Modal Tambah -->
    {{-- <form action="{{ route('bast.edit') }}" method="PUT"> --}}
        @csrf
        <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">

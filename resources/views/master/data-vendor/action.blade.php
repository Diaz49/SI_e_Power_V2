<div class="dropdown">
    ...
    <ul class="dropdown-menu">
        <li><a href="javascript:void(0)" class="dropdown-item text-info fw-bold d-flex justify-content-between py-2"
                data-id="{{ $datavendor->id }}" type="button" data-bs-toggle="modal" data-bs-target="#modalEdit">Edit <i
        ...
        <li>
            <button class="dropdown-item text-danger fw-bold d-flex justify-content-between py-2" type="button"
                data-table-id="datavendor-table" data-url="{{ route('data-vendor.delete', $datavendor->id) }}"
                data-name="{{ $datavendor->nama_vendor }}" data-action="delete">

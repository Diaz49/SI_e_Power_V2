<div class="dropdown">
    ...
    <ul class="dropdown-menu">
        <li><a href="{{ route('po-print', $po->id) }}"
                class="dropdown-item text-info fw-bold d-flex justify-content-between py-2" data-id="{{ $po->id }}"
                type="button">Cetak PO <i
        ...
        <li><a href="javascript:void(0)" class="dropdown-item text-info fw-bold d-flex justify-content-between py-2"
                data-id="{{ $po->id }}" type="button" data-bs-toggle="modal"
        ...
        <li>
            <button class="dropdown-item text-danger fw-bold d-flex justify-content-between py-2" id="btnDeletePo"
                type="button" data-table-id="purchaseorder-table" data-url="{{ route('po.delete', $po->id) }}"

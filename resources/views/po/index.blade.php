...
@section('content')
            ...
            <div class="row">
                <form class="col-md-6" id="formTambahDetail">
                    <div class="card p-4">
                        ...
                        <input type="text" class="form-control" name="detail_kode_po" id="detail_kode_po" disabled
                            value="" placeholder="Otomatis terisi">
                        @error('detail_kode_po')
                            <div class="text-danger error">{{ $message }}</div>
                        @enderror
                        <div class="mb-1 mt-2 label">Nama Barang</div>
                        ...
                        <input type="number" class="form-control" name="harga_satuan" id="harga_satuan" value=""
                ...
                <form class="col-md-6" method="POST" id="formTambahHeader">
                    ...
                    <div class="card p-4">
                        ...
                        <select type="text" class="form-control js-example-basic-single" name="nama_vendor"
                            id="nama_vendor" value="" placeholder="Masukkan Nama Vendor">
                        ...
                        <input type="number" class="form-control" name="diskon_rupiah" id="diskon_rupiah"
    ...
    @push('scripts')
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const input1 = document.getElementById('kode_purchase_order');

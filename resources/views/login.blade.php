...
<head>
    ...
    <style>
        ...
        @keyframes wave-animation {
            ...
            /* Bergerak sedikit ke kanan untuk efek gelombang */
            100% {
                transform: translateX(0);
            }
        }
        ...
        .boat {
            position: absolute;
            bottom: 12%;
            /* Tinggi kapal di atas gelombang */
            left: 80%;
            width: 180px;
            height: 180px;
            background-image: url('https://img2.pngdownload.id/20180219/fbw/kisspng-caravel-ship-clip-art-ship-vector-5a8aab4c6901f2.8635440015190372604301.jpg');
            /* Ganti dengan URL gambar kapal */
        ...
        @keyframes boat-movement {
            ...
            /* Gerakan naik-turun untuk efek gelombang */
        }
    </style>
</head>
...
<body>
    ...
    <form class="login-container" action="{{ route('login.authenticate') }}" method="POST">
        ...
        <button type="submit" class="login-button">Log
            In</button>
        {{-- </a> --}}
        {{-- </form> --}}
    </form>
